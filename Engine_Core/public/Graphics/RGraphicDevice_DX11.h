...
public:
	...
	void	BindViewPort();
	void	BindRenderTargets(UINT NumViews = 1,
								ID3D11RenderTargetView* const* ppRenderTargetViews = nullptr,
...
inline RGraphicDevice_DX11*& GetDevice()
{
	static RGraphicDevice_DX11* device = nullptr;
	return device;
}

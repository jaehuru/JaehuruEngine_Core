...
#pragma endregion
	...
	void LoadShaders()
	{
		...
		{
			{ EShaderStage::VS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/VS/TriangleVS.hlsl" },
			{ EShaderStage::PS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/PS/TrianglePS.hlsl" },
		};

		map<EShaderStage, wstring> spriteShaderPaths = 
		{
			{ EShaderStage::VS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/VS/SpriteDefaultVS.hlsl" },
			{ EShaderStage::PS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/PS/SpriteDefaultPS.hlsl" },
		};

		map<EShaderStage, wstring> wireframeShaderPaths =
		{
			{ EShaderStage::VS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/VS/WireframeVS.hlsl" },
			{ EShaderStage::PS, L"../JaehuruEngine_Core/Engine_Core/Shaders_SOURCE/PS/WireframePS.hlsl" },
		};
